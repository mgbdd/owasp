...
# CSRF (Cross-Site Request Forgery)- атака, при которой злоумышленник заставляет жертву выполнить нежелательные действия в веб-приложении без её ведома.
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', debug=True)     # A05 Security Misconfiguration
                            ...
                            # host='0.0.0.0' позволяет доступ к приложению извне контейнера